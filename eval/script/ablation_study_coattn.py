...
def main(input_dir):
    ...
    module_file = input_dir + 'ablation_nocoattn_module_detection.tsv'
    ...
    metric = 'Accuracy'
    func_file = input_dir + 'ablation_nocoattn_function_prediction.tsv'
    ...
    coann_file = input_dir + 'ablation_nocoattn_coannotation.tsv'
